...
class ModuloCarga extends React.Component {
    ...
    handleSubmit = (e) => {
        ...
        fetch('https://moduloc-back.herokuapp.com/upload', sentData)
            .then(response => {
    ...
    render() {
        return (
            <div>
                <meta http-equiv="refresh" content="600;url=http://localhost:3000" />
                        ...
                        <div className="row">
                            ...
                            <div className="col-xs-4 col-md-2">
                                <input className="labelinput"
                                       value={this.state.value} onChange={this.handleInput2Change}
                            ...
                            <div className="col-xs-6 col-md-3">
                                <select
                                    ...
                                    required
                                    value={this.state.formato} onChange={this.handleInput1Change}
                                    onChange={(e) => {
                                        this.setState({formato: e.target.value})
                                    }}
                                >
